...
router.post('/empupdtsearch', async (req, res, next) => {
 ...
 // Call the get function to quuery the DB, set a two second wait to give the function time to return data
    dbcallsget.data.dbCallsGet(dburl,dbstring,dbmethod,dbbody,rtnejs,res);
...
//router.post('/empupdtsearch', async (req, res, next) => {
  ...
  // Call the get function to quuery the DB, set a two second wait to give the function time to return data
  await dbcallsget.data.dbCallsGet(dburl,dbstring,dbmethod,dbbody,rtnejs,res)
 .then((data) => { data
                    console.log('thendata',data)
   })
  //console.log("res",res.render)
  // console.log ('x', x);
